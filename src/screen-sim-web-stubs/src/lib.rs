...
impl WebGl2RenderingContext {
    ...
    pub const COLOR_BUFFER_BIT : u32 = 0;
    ...
    pub fn get_uniform_location(&self, _: &WebGlProgram, _: &str) -> Location { Location{} }
    ...
    pub fn get_program_info_log(&self, _: &WebGlProgram) -> Option<&'static str> { Some("")}
    pub fn get_shader_info_log(&self, _: &WebGlShader) -> Option<&'static str> { Some("")}
    pub fn get_program_parameter(&self, _: &WebGlProgram, _:u32) -> ProgramParameter { ProgramParameter{} }
    pub fn get_shader_parameter(&self, _: &WebGlShader, _:u32) -> ProgramParameter { ProgramParameter{} }
    ...
    pub fn create_framebuffer(&self) -> Option<WebGlFramebuffer> { Some(WebGlFramebuffer{}) }
    ...
    pub fn create_renderbuffer(&self) -> Option<WebGlFramebuffer> { Some(WebGlFramebuffer{}) }
...
pub struct JsValue {}
impl JsValue {
    pub fn from(_: u32) -> JsValue { JsValue{} }
}
pub struct Location {}
impl Location {
    pub fn as_ref(&self) -> u32 { 0 }
}
...
impl Float32Array {
    pub fn new(_: &JsValue) -> Float32Array { Float32Array{} }
    pub fn fill(&self, _: f32, _: u32, _: u32) {}
    pub fn buffer(&self) -> ArrayBuffer { ArrayBuffer{} }
}
