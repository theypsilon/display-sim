...
pub struct Input {
    ...
    pub increase_pixel_width: bool,
    pub decrease_pixel_width: bool,
    ...
    pub translation_speed_up: BooleanButton,
    pub translation_speed_down: BooleanButton,
    pub turn_speed_up: BooleanButton,
    pub turn_speed_down: BooleanButton,
    pub filter_speed_up: BooleanButton,
    pub filter_speed_down: BooleanButton,
...
impl Input {
    pub fn new() -> WasmResult<Input> {
        Ok(Input {
            ...
            increase_pixel_width: false,
            decrease_pixel_width: false,
            ...
            translation_speed_up: BooleanButton::new(),
            translation_speed_down: BooleanButton::new(),
            turn_speed_up: BooleanButton::new(),
            turn_speed_down: BooleanButton::new(),
            filter_speed_up: BooleanButton::new(),
            filter_speed_down: BooleanButton::new(),
