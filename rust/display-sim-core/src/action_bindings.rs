...
pub fn on_button_action(input: &mut Input, button_action: &str, pressed: bool) -> bool {
    ...
    match action.as_ref() {
        ...
        "custom-scaling-resolution-width-inc" => input.custom_scaling_resolution_width.increase.input = pressed,
        "custom-scaling-resolution-width-dec" => input.custom_scaling_resolution_width.decrease.input = pressed,
        "custom-scaling-resolution-height-inc" => input.custom_scaling_resolution_height.increase.input = pressed,
        "custom-scaling-resolution-height-dec" => input.custom_scaling_resolution_height.decrease.input = pressed,
        "custom-scaling-aspect-ratio-x-inc" => input.custom_scaling_aspect_ratio_x.increase.input = pressed,
        "custom-scaling-aspect-ratio-x-dec" => input.custom_scaling_aspect_ratio_x.decrease.input = pressed,
        "custom-scaling-aspect-ratio-y-inc" => input.custom_scaling_aspect_ratio_y.increase.input = pressed,
        "custom-scaling-aspect-ratio-y-dec" => input.custom_scaling_aspect_ratio_y.decrease.input = pressed,
