...
pub fn on_button_action(input: &mut Input, button_action: &str, pressed: bool) -> bool {
    match button_action {
        ...
        "." => {
            if !input.input_focused {
                input.next_pixels_shadow_shape.increase.input = pressed
            }
        }
        "+" => {
            if !input.input_focused {
        ...
        "feature-change-pixel-shadow-shape-inc" => input.next_pixels_shadow_shape.increase.input = pressed,
        "feature-change-pixel-shadow-shape-dec" => input.next_pixels_shadow_shape.decrease.input = pressed,
